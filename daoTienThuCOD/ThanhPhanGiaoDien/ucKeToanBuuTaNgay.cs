...
{
    public partial class ucKeToanBuuTaNgay : UserControl
    {
        public ucKeToanBuuTaNgay()
        {
            InitializeComponent();
        ...
        private List<sp_tblKeToanBuuTaNgay_DanhSachResult> lstKTBT = new List<sp_tblKeToanBuuTaNgay_DanhSachResult>();
        ...
        private void HienThiDuLieu()
        {
            ...
            for (int i = 0; i < lstKTBT.Count; i++)
            {
                ...
                Dong.Cells["GiuLaiSanLuong"].Value = lstKTBT[i].GiuLaiSanLuong.Value.ToString("######");
                Dong.Cells["GiuLaiSoTien"].Value = lstKTBT[i].GiuLaiSoTien.Value.ToString("N0", CultureInfo.CreateSpecificCulture("vi-VN"));
            ...
            Dong.Cells["GiuLaiSanLuong"].Value = lstKTBT.Sum(x => x.GiuLaiSanLuong).Value.ToString("######");
            Dong.Cells["GiuLaiSoTien"].Value = lstKTBT.Sum(x => x.GiuLaiSoTien).Value.ToString("N0", CultureInfo.CreateSpecificCulture("vi-VN"));
        ...
        {            
            ...
            sp_tblKeToanBuuTaNgay_DanhSachResult _ch;
            _ch = lstKTBT[i];
