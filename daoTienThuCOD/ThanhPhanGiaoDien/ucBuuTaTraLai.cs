...
{
    public partial class ucBuuTaTraLai : UserControl
    {
        public ucBuuTaTraLai()
        {
            InitializeComponent();
        ...
        private List<sp_tblPhanBuuTa_DanhSach_BuuTaResult> lstPHBT = new List<sp_tblPhanBuuTa_DanhSach_BuuTaResult>();
